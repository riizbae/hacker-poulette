...
if (isset($_POST['mail']) AND isset($_POST['lastname'])AND isset($_POST['firstname']) AND isset($_POST['gender'])
AND isset($_POST['country'])AND $_POST['subject']){
...
// modif variable avec condition
    ...
    if ($_POST['message']==""){
      $corp = "Hello $gender, $lastname $firstname this email is send to you because we have receive an request from you about $reason
      ";
    }
